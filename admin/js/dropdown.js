  ...
  var methods = {
    ...
    init: function(options) {
      ...
      function initElement($select) {
        ...
        var $input = $('<div class="fakeinput"><span class=content></span><span class="fakebg" ></span></div>');
        ...
        $select.find("option").each(function() {
          ...
          methods._addOption($ul, $this, $value);
    ...
    _select: function($dropdown, $target) {
      ...
      var $select = $dropdown.data("select"),
          ...
          $input  = $dropdown.find("span.content");
          $input_bg  = $dropdown.find("span.fakebg");
      // Is it a multi select?
      var multi = $select.attr("multiple");
      ...
      if (!multi) {
        ...
        var opt_text = $target.attr('value');
        var opt_color = $target.text();

        if(opt_text === 0 ){
        }else {
          var tokens = $target.attr('data-title').split("-").filter(function(t) {return t !== ""; }),
            res = [],
            i,
            len,
            component;
        ...
        $input.text(opt_text);
        $input_bg.css('background-color', opt_color);
    ...
    _addOption: function($ul, $this, $value) {
      // Create the option
      var $option = $("<li></li>");
      ...
      var tokens = $value.split("-").filter(function(t) {return t !== ""; }),
          res = [],
          i,
          len,
          component;
      ...
      var $option_inner = $("<span style='background-color:"+ $this.text() +";'></span>");
      $option.append($option_inner);
